...
module TestHelpers
  module Paths
    def app_template_path
      @app_template_path ||= File.realpath(Dir.mktmpdir("/tmp/templates/app_template/"))
    end

    def bootsnap_cache_path
      @bootsnap_path ||= File.realpath(Dir.mktmpdir("/tmp/templates/bootsnap/"))
    end

    def tmp_path(*args)
      @tmp_path ||= File.realpath(Dir.mktmpdir("/tmp/rails_app"))
...
unless defined?(RAILS_ISOLATED_ENGINE)
  Module.new do
